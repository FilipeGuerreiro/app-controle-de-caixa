...
// Enable expect/actual classes support for multiplatform compilations (Kotlin compiler flag)
// Add compiler arg for Kotlin compilation tasks (common + JVM)
tasks.withType(org.jetbrains.kotlin.gradle.tasks.KotlinCompileCommon::class.java).configureEach {
    compilerOptions {
